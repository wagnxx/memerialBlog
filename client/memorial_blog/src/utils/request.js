...
import { cleanUserInfo } from "./logic";
 ...
 */
export default function request(url, body, method = "GET") {
  let options = {
  ...
  if (mergeOptions.method.toUpperCase() === "GET" && body) {
    url += "?";
    url += o2s(body);
  } else {
